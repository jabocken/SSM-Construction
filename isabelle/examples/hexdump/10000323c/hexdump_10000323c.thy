...
(*
#####################################
## Entry = 10000323c, blockId == 0 ##
#####################################
*)

htriple "ht_10000323c"
 Separations ""
 Assertions  ""
 ...
 Instruction "10000323c: PUSH RBP 1"
...
htriple "ht_10000323d"
 ...
 Instruction "10000323d: MOV RBP, RSP 3"
...
htriple "ht_100003240"
 ...
 Instruction "100003240: MOV RDX, RDI 3"
...
htriple "ht_100003243"
 ...
 Instruction "100003243: LEA RSI, [RIP + 3219] 7"
 Post  "RAX = RAX_0 ; RCX = RCX_0 ; RDX = RDI_0 ; RDI = RDI_0 ; RSI = 0x100003edd ; RSP = (RSP_0 -64 8) ; RBP = (RSP_0 -64 8) ; R9 = R9_0 ; R8 = R8_0 ; XMM0 = XMM0_0 ; [RSP_0,8] = [RSP_0,8]_0 ; [(RSP_0 -64 8),8] = RBP_0"
  by (htriple_solver seps: conjI[OF seps asserts,simplified] assms: assms)
...
htriple "ht_10000324a"
 Separations ""
 Assertions  ""
 Pre   "RAX = RAX_0 ; RCX = RCX_0 ; RDX = RDI_0 ; RDI = RDI_0 ; RSI = 0x100003edd ; RSP = (RSP_0 -64 8) ; RBP = (RSP_0 -64 8) ; R9 = R9_0 ; R8 = R8_0 ; XMM0 = XMM0_0 ; [RSP_0,8] = [RSP_0,8]_0 ; [(RSP_0 -64 8),8] = RBP_0"
 Instruction "10000324a: MOV EDI, 1 5"
 Post  "RAX = RAX_0 ; RCX = RCX_0 ; RDX = RDI_0 ; RDI = 1 ; RSI = 0x100003edd ; RSP = (RSP_0 -64 8) ; RBP = (RSP_0 -64 8) ; R9 = R9_0 ; R8 = R8_0 ; XMM0 = XMM0_0 ; [RSP_0,8] = [RSP_0,8]_0 ; [(RSP_0 -64 8),8] = RBP_0"
  by (htriple_solver seps: conjI[OF seps asserts,simplified] assms: assms)


htriple "ht_10000324f"
 Separations ""
 Assertions  ""
 Pre   "RAX = RAX_0 ; RCX = RCX_0 ; RDX = RDI_0 ; RDI = 1 ; RSI = 0x100003edd ; RSP = (RSP_0 -64 8) ; RBP = (RSP_0 -64 8) ; R9 = R9_0 ; R8 = R8_0 ; XMM0 = XMM0_0 ; [RSP_0,8] = [RSP_0,8]_0 ; [(RSP_0 -64 8),8] = RBP_0"
 Instruction "10000324f: XOR EAX, EAX 2"
 Post  "RAX = 0 ; RCX = RCX_0 ; RDX = RDI_0 ; RDI = 1 ; RSI = 0x100003edd ; RSP = (RSP_0 -64 8) ; RBP = (RSP_0 -64 8) ; R9 = R9_0 ; R8 = R8_0 ; XMM0 = XMM0_0 ; [RSP_0,8] = [RSP_0,8]_0 ; [(RSP_0 -64 8),8] = RBP_0"
  by (htriple_solver seps: conjI[OF seps asserts,simplified] assms: assms)
...
htriple "ht_100003251"
 Separations ""
 Assertions  ""
 Pre   "RAX = 0 ; RCX = RCX_0 ; RDX = RDI_0 ; RDI = 1 ; RSI = 0x100003edd ; RSP = (RSP_0 -64 8) ; RBP = (RSP_0 -64 8) ; R9 = R9_0 ; R8 = R8_0 ; XMM0 = XMM0_0 ; [RSP_0,8] = [RSP_0,8]_0 ; [(RSP_0 -64 8),8] = RBP_0"
 Instruction "100003251: ExternalCall fun__errx 5"
